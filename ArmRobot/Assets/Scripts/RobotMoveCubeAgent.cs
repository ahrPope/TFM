...
public class RobotMoveCubeAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        Vector3 posicionIncialCubo = new Vector3(0.472000003f, 0.777999997f, -0.0379999988f);
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        */
        ...
        if ((goal.GetComponent<Goal>().goal || cube.GetComponent<TargetTouchDetector>().hasTouchedTarget) && cubeIsGripped)
        {
            Debug.Log("Finished!");
